...
const onToggleInner = `Bdrs(50%) Bgc(#000000) Bd Sq(28px) Trstf(eio) Trsdu($fast) Bdc($c-pink) TranslateX(10px)`;

const offToggle = `CenterAlign Bdrs(16px) W(50px) H(30px) Bd Pe(n) Trstf(eio) Trsdu($fast) Bdc($c-divider) Bgc($c-divider)`;
const offToggleInner = `Bdrs(50%) Bgc(#000000) Bd Sq(28px) Trstf(eio) Trsdu($fast) Bdc($c-divider) TranslateX(-10px)`;

const topBanner = `
<div class="desktopNavbar Pos(r) Z(2) Trsdu($normal) Tsrdu($regular) CenterAlign Bg($blue-gradient)">
  <a class="Pos(a) D(f) Ai(c) C(#000000) Trsdu($normal) T(50%) Fz($m) Fz($responsiveLarge)--m Fz($ml)--l Whs(nw) Start(50%) Translate(-50%,-50%)" href="/app/profile">
...
<div class="settings__container settings__section Bgc(#000000) BdY Bdc($c-divider)">
    <div class="menuItem Bgc(#000000) Bd focus-visible_Bdc($c-superlike-blue) Bdc(t) Trsdu($fast)">
...
<div class="iconCombo Pos(r) P(16px) W(100%) CenterAlign Bdrs(4px) Bxsh($bxsh-btn) Pt(30px) Mstart(12px)--s Mstart(24px)--ml Mend(5px) Cur(p) Bgc(#000000) Ta(c)">
  <div class="iconCombo__icon Pos(a) Start(50%) T(0) Translate(-50%,-50%)">
      <span class="Sq(48px) Bxsh($bxsh-btn) Bgc(#000000) Bdrs(50%) P(0) CenterAlign Mx(a) productIcon__button productIcon__button--medium">
...
<div class="iconCombo Pos(r) P(16px) W(100%) CenterAlign Bdrs(4px) Bxsh($bxsh-btn) Pt(30px) Mend(12px)--s Mend(24px)--ml Mstart(5px)--ml Cur(p) Bgc(#000000) Ta(c)">
  <div class="iconCombo__icon Pos(a) Start(50%) T(0) Translate(-50%,-50%)">
      <span class="Sq(48px) Bxsh($bxsh-btn) Bgc(#000000) Bdrs(50%) P(0) CenterAlign Mx(a) productIcon__button productIcon__button--medium">
