import{aI as Ae,c1 as so,c2 as co,b$ as uo,n as O,k as n,bT as ho,bU as fo,l as b,p as d,au as Fe,c3 as vo,d as je,h as c,ax as bo,at as go,w as Ee,x as ve,r as D,aC as Ne,j as k,C as Pe,z as De,ap as mo,H as Be,aE as wo,O as L,aN as he,aM as fe,L as Re,q as _e,aX as Me,bK as Se,v as U,a_ as po,av as xo,E as K,an as ze,I}from"./popup/popup.js";import{B as yo,V as ko,h as Co,j as $e,b as Oe}from"./DescriptionsItem.js";function Ro(o){const i="rgba(0, 0, 0, .85)",w="0 2px 8px 0 rgba(0, 0, 0, 0.12)",{railColor:h,primaryColor:l,baseColor:f,cardColor:x,modalColor:C,popoverColor:A,borderRadius:$,fontSize:_,opacityDisabled:V}=o;return Object.assign(Object.assign({},so),{fontSize:_,markFontSize:_,railColor:h,railColorHover:h,fillColor:l,fillColorHover:l,opacityDisabled:V,handleColor:"#FFF",dotColor:x,dotColorModal:C,dotColorPopover:A,handleBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowHover:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowActive:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowFocus:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",indicatorColor:i,indicatorBoxShadow:w,indicatorTextColor:f,indicatorBorderRadius:$,dotBorder:`2px solid ${h}`,dotBorderActive:`2px solid ${l}`,dotBoxShadow:""})}const So={common:Ae,self:Ro};function zo(o){const{primaryColor:i,opacityDisabled:w,borderRadius:h,textColor3:l}=o;return Object.assign(Object.assign({},co),{iconColor:l,textColor:"white",loadingColor:i,opacityDisabled:w,railColor:"rgba(0, 0, 0, .14)",railColorActive:i,buttonBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",buttonColor:"#FFF",railBorderRadiusSmall:h,railBorderRadiusMedium:h,railBorderRadiusLarge:h,buttonBorderRadiusSmall:h,buttonBorderRadiusMedium:h,buttonBorderRadiusLarge:h,boxShadowFocus:`0 0 0 2px ${uo(i,{alpha:.2})}`})}const Bo={common:Ae,self:zo},$o=O([n("slider",`
 ...
 `),b("left",`
 margin-right: 12px;
 `),Fe()]),ho(n("slider",[n("slider-dot","background-color: var(--n-dot-color-modal);")])),fo(n("slider",[n("slider-dot","background-color: var(--n-dot-color-popover);")]))]);function He(o){return window.TouchEvent&&o instanceof window.TouchEvent}function Ie(){const o=new Map,i=w=>h=>{o.set(w,h)};return vo(()=>{o.clear()}),[o,i]}const Vo=0,To=Object.assign(Object.assign({},ve.props),{to:$e.propTo,defaultValue:{type:[Number,Array],default:0},marks:Object,disabled:{type:Boolean,default:void 0},formatTooltip:Function,keyboard:{type:Boolean,default:!0},min:{type:Number,default:0},max:{type:Number,default:100},step:{type:[Number,String],default:1},range:Boolean,value:[Number,Array],placement:String,showTooltip:{type:Boolean,default:void 0},tooltip:{type:Boolean,default:!0},vertical:Boolean,reverse:Boolean,"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],onDragstart:[Function],onDragend:[Function]}),Ho=je({name:"Slider",props:To,slots:Object,setup(o){const{mergedClsPrefixRef:i,namespaceRef:w,inlineThemeDisabled:h}=Ee(o),l=ve("Slider","-slider",$o,So,o,i),f=D(null),[x,C]=Ie(),[A,$]=Ie(),_=D(new Set),V=Ne(o),{mergedDisabledRef:v}=V,T=k(()=>{const{step:e}=o;if(Number(e)<=0||e==="mark")return 0;const t=e.toString();let a=0;return t.includes(".")&&(a=t.length-t.indexOf(".")-1),a}),z=D(o.defaultValue),be=Pe(o,"value"),J=Oe(be,z),R=k(()=>{const{value:e}=J;return(o.range?e:[e]).map(E)}),ne=k(()=>R.value.length>2),ge=k(()=>o.placement===void 0?o.vertical?"right":"top":o.placement),re=k(()=>{const{marks:e}=o;return e?Object.keys(e).map(Number.parseFloat):null}),S=D(-1),Q=D(-1),y=D(-1),s=D(!1),H=D(!1),j=k(()=>{const{vertical:e,reverse:t}=o;return e?t?"top":"bottom":t?"right":"left"}),W=k(()=>{if(ne.value)return;const e=R.value,t=X(o.range?Math.min(...e):o.min),a=X(o.range?Math.max(...e):e[0]),{value:r}=j;return o.vertical?{[r]:`${t}%`,height:`${a-t}%`}:{[r]:`${t}%`,width:`${a-t}%`}}),Z=k(()=>{const e=[],{marks:t}=o;if(t){const a=R.value.slice();a.sort((p,m)=>p-m);const{value:r}=j,{value:u}=ne,{range:g}=o,M=u?()=>!1:p=>g?p>=a[0]&&p<=a[a.length-1]:p<=a[0];for(const p of Object.keys(t)){const m=Number(p);e.push({active:M(m),key:m,label:t[p],style:{[r]:`${X(m)}%`}})}}return e});function ee(e,t){const a=X(e),{value:r}=j;return{[r]:`${a}%`,zIndex:t===S.value?1:0}}function ie(e){return o.showTooltip||y.value===e||S.value===e&&s.value}function me(e){return s.value?!(S.value===e&&Q.value===e):!0}function we(e){var t;~e&&(S.value=e,(t=x.get(e))===null||t===void 0||t.focus())}function pe(){A.forEach((e,t)=>{ie(t)&&e.syncPosition()})}function F(e){const{"onUpdate:value":t,onUpdateValue:a}=o,{nTriggerFormInput:r,nTriggerFormChange:u}=V;a&&L(a,e),t&&L(t,e),z.value=e,r(),u()}function le(e){const{range:t}=o;if(t){if(Array.isArray(e)){const{value:a}=R;e.join()!==a.join()&&F(e)}}else Array.isArray(e)||R.value[0]!==e&&F(e)}function oe(e,t){if(o.range){const a=R.value.slice();a.splice(t,1,e),le(a)}else le(e)}function B(e,t,a){const r=a!==void 0;a||(a=e-t>0?1:-1);const u=re.value||[],{step:g}=o;if(g==="mark"){const m=N(e,u.concat(t),r?a:void 0);return m?m.value:t}if(g<=0)return t;const{value:M}=T;let p;if(r){const m=Number((t/g).toFixed(M)),P=Math.floor(m),ke=m>P?P:P-1,Ce=m<P?P:P+1;p=N(t,[Number((ke*g).toFixed(M)),Number((Ce*g).toFixed(M)),...u],a)}else{const m=ye(e);p=N(e,[...u,m])}return p?E(p.value):t}function E(e){return Math.min(o.max,Math.max(o.min,e))}function X(e){const{max:t,min:a}=o;return(e-a)/(t-a)*100}function xe(e){const{max:t,min:a}=o;return a+(t-a)*e}function ye(e){const{step:t,min:a}=o;if(Number(t)<=0||t==="mark")return e;const r=Math.round((e-a)/t)*t+a;return Number(r.toFixed(T.value))}function N(e,t=re.value,a){if(!(t!=null&&t.length))return null;let r=null,u=-1;for(;++u<t.length;){const g=t[u]-e,M=Math.abs(g);(a===void 0||g*a>0)&&(r===null||M<r.distance)&&(r={index:u,distance:M,value:t[u]})}return r}function Y(e){const t=f.value;if(!t)return;const a=He(e)?e.touches[0]:e,r=t.getBoundingClientRect();let u;return o.vertical?u=(r.bottom-a.clientY)/r.height:u=(a.clientX-r.left)/r.width,o.reverse&&(u=1-u),xe(u)}function te(e){if(v.value||!o.keyboard)return;const{vertical:t,reverse:a}=o;switch(e.key){case"ArrowUp":e.preventDefault(),se(t&&a?-1:1);break;case"ArrowRight":e.preventDefault(),se(!t&&a?-1:1);break;case"ArrowDown":e.preventDefault(),se(t&&a?1:-1);break;case"ArrowLeft":e.preventDefault(),se(!t&&a?1:-1);break}}function se(e){const t=S.value;if(t===-1)return;const{step:a}=o,r=R.value[t],u=Number(a)<=0||a==="mark"?r:r+a*e;oe(B(u,r,e>0?1:-1),t)}function Ue(e){var t,a;if(v.value||!He(e)&&e.button!==Vo)return;const r=Y(e);if(r===void 0)return;const u=R.value.slice(),g=o.range?(a=(t=N(r,u))===null||t===void 0?void 0:t.index)!==null&&a!==void 0?a:-1:0;g!==-1&&(e.preventDefault(),we(g),Ke(),oe(B(r,R.value[g]),g))}function Ke(){s.value||(s.value=!0,o.onDragstart&&L(o.onDragstart),he("touchend",document,ue),he("mouseup",document,ue),he("touchmove",document,ce),he("mousemove",document,ce))}function de(){s.value&&(s.value=!1,o.onDragend&&L(o.onDragend),fe("touchend",document,ue),fe("mouseup",document,ue),fe("touchmove",document,ce),fe("mousemove",document,ce))}function ce(e){const{value:t}=S;if(!s.value||t===-1){de();return}const a=Y(e);a!==void 0&&oe(B(a,R.value[t]),t)}function ue(){de()}function Le(e){S.value=e,v.value||(y.value=e)}function We(e){S.value===e&&(S.value=-1,de()),y.value===e&&(y.value=-1)}function Xe(e){y.value=e}function Ye(e){y.value===e&&(y.value=-1)}De(S,(e,t)=>void Re(()=>Q.value=t)),De(J,()=>{if(o.marks){if(H.value)return;H.value=!0,Re(()=>{H.value=!1})}Re(pe)}),mo(()=>{de()});const Ve=k(()=>{const{self:{markFontSize:e,railColor:t,railColorHover:a,fillColor:r,fillColorHover:u,handleColor:g,opacityDisabled:M,dotColor:p,dotColorModal:m,handleBoxShadow:P,handleBoxShadowHover:ke,handleBoxShadowActive:Ce,handleBoxShadowFocus:qe,dotBorder:Ge,dotBoxShadow:Je,railHeight:Qe,railWidthVertical:Ze,handleSize:eo,dotHeight:oo,dotWidth:to,dotBorderRadius:ao,fontSize:no,dotBorderActive:ro,dotColorPopover:io},common:{cubicBezierEaseInOut:lo}}=l.value;return{"--n-bezier":lo,"--n-dot-border":Ge,"--n-dot-border-active":ro,"--n-dot-border-radius":ao,"--n-dot-box-shadow":Je,"--n-dot-color":p,"--n-dot-color-modal":m,"--n-dot-color-popover":io,"--n-dot-height":oo,"--n-dot-width":to,"--n-fill-color":r,"--n-fill-color-hover":u,"--n-font-size":no,"--n-handle-box-shadow":P,"--n-handle-box-shadow-active":Ce,"--n-handle-box-shadow-focus":qe,"--n-handle-box-shadow-hover":ke,"--n-handle-color":g,"--n-handle-size":eo,"--n-opacity-disabled":M,"--n-rail-color":t,"--n-rail-color-hover":a,"--n-rail-height":Qe,"--n-rail-width-vertical":Ze,"--n-mark-font-size":e}}),q=h?Be("slider",void 0,Ve,o):void 0,Te=k(()=>{const{self:{fontSize:e,indicatorColor:t,indicatorBoxShadow:a,indicatorTextColor:r,indicatorBorderRadius:u}}=l.value;return{"--n-font-size":e,"--n-indicator-border-radius":u,"--n-indicator-box-shadow":a,"--n-indicator-color":t,"--n-indicator-text-color":r}}),G=h?Be("slider-indicator",void 0,Te,o):void 0;return{mergedClsPrefix:i,namespace:w,uncontrolledValue:z,mergedValue:J,mergedDisabled:v,mergedPlacement:ge,isMounted:wo(),adjustedTo:$e(o),dotTransitionDisabled:H,markInfos:Z,isShowTooltip:ie,shouldKeepTooltipTransition:me,handleRailRef:f,setHandleRefs:C,setFollowerRefs:$,fillStyle:W,getHandleStyle:ee,activeIndex:S,arrifiedValues:R,followerEnabledIndexSet:_,handleRailMouseDown:Ue,handleHandleFocus:Le,handleHandleBlur:We,handleHandleMouseEnter:Xe,handleHandleMouseLeave:Ye,handleRailKeyDown:te,indicatorCssVars:h?void 0:Te,indicatorThemeClass:G==null?void 0:G.themeClass,indicatorOnRender:G==null?void 0:G.onRender,cssVars:h?void 0:Ve,themeClass:q==null?void 0:q.themeClass,onRender:q==null?void 0:q.onRender}},render(){var o;const{mergedClsPrefix:i,themeClass:w,formatTooltip:h}=this;return(o=this.onRender)===null||o===void 0||o.call(this),c("div",{class:[`${i}-slider`,w,{[`${i}-slider--disabled`]:this.mergedDisabled,[`${i}-slider--active`]:this.activeIndex!==-1,[`${i}-slider--with-mark`]:this.marks,[`${i}-slider--vertical`]:this.vertical,[`${i}-slider--reverse`]:this.reverse}],style:this.cssVars,onKeydown:this.handleRailKeyDown,onMousedown:this.handleRailMouseDown,onTouchstart:this.handleRailMouseDown},c("div",{class:`${i}-slider-rail`},c("div",{class:`${i}-slider-rail__fill`,style:this.fillStyle}),this.marks?c("div",{class:[`${i}-slider-dots`,this.dotTransitionDisabled&&`${i}-slider-dots--transition-disabled`]},this.markInfos.map(l=>c("div",{key:l.key,class:[`${i}-slider-dot`,{[`${i}-slider-dot--active`]:l.active}],style:l.style}))):null,c("div",{ref:"handleRailRef",class:`${i}-slider-handles`},this.arrifiedValues.map((l,f)=>{const x=this.isShowTooltip(f);return c(yo,null,{default:()=>[c(ko,null,{default:()=>c("div",{ref:this.setHandleRefs(f),class:`${i}-slider-handle-wrapper`,tabindex:this.mergedDisabled?-1:0,role:"slider","aria-valuenow":l,"aria-valuemin":this.min,"aria-valuemax":this.max,"aria-orientation":this.vertical?"vertical":"horizontal","aria-disabled":this.disabled,style:this.getHandleStyle(l,f),onFocus:()=>{this.handleHandleFocus(f)},onBlur:()=>{this.handleHandleBlur(f)},onMouseenter:()=>{this.handleHandleMouseEnter(f)},onMouseleave:()=>{this.handleHandleMouseLeave(f)}},bo(this.$slots.thumb,()=>[c("div",{class:`${i}-slider-handle`})]))}),this.tooltip&&c(Co,{ref:this.setFollowerRefs(f),show:x,to:this.adjustedTo,enabled:this.showTooltip&&!this.range||this.followerEnabledIndexSet.has(f),teleportDisabled:this.adjustedTo===$e.tdkey,placement:this.mergedPlacement,containerClass:this.namespace},{default:()=>c(go,{name:"fade-in-scale-up-transition",appear:this.isMounted,css:this.shouldKeepTooltipTransition(f),onEnter:()=>{this.followerEnabledIndexSet.add(f)},onAfterLeave:()=>{this.followerEnabledIndexSet.delete(f)}},{default:()=>{var C;return x?((C=this.indicatorOnRender)===null||C===void 0||C.call(this),c("div",{class:[`${i}-slider-handle-indicator`,this.indicatorThemeClass,`${i}-slider-handle-indicator--${this.mergedPlacement}`],style:this.indicatorCssVars},typeof h=="function"?h(l):l)):null}})})]})})),this.marks?c("div",{class:`${i}-slider-marks`},this.markInfos.map(l=>c("div",{key:l.key,class:`${i}-slider-mark`,style:l.style},typeof l.label=="function"?l.label():l.label))):null))}}),Fo=n("switch",`
 height: var(--n-height);
...
`,[d("children-placeholder",`
 ...
 cursor: not-allowed;
 opacity: .5;
 `)])]),Do=Object.assign(Object.assign({},ve.props),{size:{type:String,default:"medium"},value:{type:[String,Number,Boolean],default:void 0},loading:Boolean,defaultValue:{type:[String,Number,Boolean],default:!1},disabled:{type:Boolean,default:void 0},round:{type:Boolean,default:!0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],checkedValue:{type:[String,Number,Boolean],default:!0},uncheckedValue:{type:[String,Number,Boolean],default:!1},railStyle:Function,rubberBand:{type:Boolean,default:!0},onChange:[Function,Array]});let ae;const Io=je({name:"Switch",props:Do,slots:Object,setup(o){ae===void 0&&(typeof CSS<"u"?typeof CSS.supports<"u"?ae=CSS.supports("width","max(1px)"):ae=!1:ae=!0);const{mergedClsPrefixRef:i,inlineThemeDisabled:w}=Ee(o),h=ve("Switch","-switch",Fo,Bo,o,i),l=Ne(o),{mergedSizeRef:f,mergedDisabledRef:x}=l,C=D(o.defaultValue),A=Pe(o,"value"),$=Oe(A,C),_=k(()=>$.value===o.checkedValue),V=D(!1),v=D(!1),T=k(()=>{const{railStyle:s}=o;if(s)return s({focused:v.value,checked:_.value})});function z(s){const{"onUpdate:value":H,onChange:j,onUpdateValue:W}=o,{nTriggerFormInput:Z,nTriggerFormChange:ee}=l;H&&L(H,s),W&&L(W,s),j&&L(j,s),C.value=s,Z(),ee()}function be(){const{nTriggerFormFocus:s}=l;s()}function J(){const{nTriggerFormBlur:s}=l;s()}function R(){o.loading||x.value||($.value!==o.checkedValue?z(o.checkedValue):z(o.uncheckedValue))}function ne(){v.value=!0,be()}function ge(){v.value=!1,J(),V.value=!1}function re(s){o.loading||x.value||s.key===" "&&($.value!==o.checkedValue?z(o.checkedValue):z(o.uncheckedValue),V.value=!1)}function S(s){o.loading||x.value||s.key===" "&&(s.preventDefault(),V.value=!0)}const Q=k(()=>{const{value:s}=f,{self:{opacityDisabled:H,railColor:j,railColorActive:W,buttonBoxShadow:Z,buttonColor:ee,boxShadowFocus:ie,loadingColor:me,textColor:we,iconColor:pe,[K("buttonHeight",s)]:F,[K("buttonWidth",s)]:le,[K("buttonWidthPressed",s)]:oe,[K("railHeight",s)]:B,[K("railWidth",s)]:E,[K("railBorderRadius",s)]:X,[K("buttonBorderRadius",s)]:xe},common:{cubicBezierEaseInOut:ye}}=h.value;let N,Y,te;return ae?(N=`calc((${B} - ${F}) / 2)`,Y=`max(${B}, ${F})`,te=`max(${E}, calc(${E} + ${F} - ${B}))`):(N=ze((I(B)-I(F))/2),Y=ze(Math.max(I(B),I(F))),te=I(B)>I(F)?E:ze(I(E)+I(F)-I(B))),{"--n-bezier":ye,"--n-button-border-radius":xe,"--n-button-box-shadow":Z,"--n-button-color":ee,"--n-button-width":le,"--n-button-width-pressed":oe,"--n-button-height":F,"--n-height":Y,"--n-offset":N,"--n-opacity-disabled":H,"--n-rail-border-radius":X,"--n-rail-color":j,"--n-rail-color-active":W,"--n-rail-height":B,"--n-rail-width":E,"--n-width":te,"--n-box-shadow-focus":ie,"--n-loading-color":me,"--n-text-color":we,"--n-icon-color":pe}}),y=w?Be("switch",k(()=>f.value[0]),Q,o):void 0;return{handleClick:R,handleBlur:ge,handleFocus:ne,handleKeyup:re,handleKeydown:S,mergedRailStyle:T,pressed:V,mergedClsPrefix:i,mergedValue:$,checked:_,mergedDisabled:x,cssVars:w?void 0:Q,themeClass:y==null?void 0:y.themeClass,onRender:y==null?void 0:y.onRender}},render(){const{mergedClsPrefix:o,mergedDisabled:i,checked:w,mergedRailStyle:h,onRender:l,$slots:f}=this;l==null||l();const{checked:x,unchecked:C,icon:A,"checked-icon":$,"unchecked-icon":_}=f,V=!(Se(A)&&Se($)&&Se(_));return c("div",{role:"switch","aria-checked":w,class:[`${o}-switch`,this.themeClass,V&&`${o}-switch--icon`,w&&`${o}-switch--active`,i&&`${o}-switch--disabled`,this.round&&`${o}-switch--round`,this.loading&&`${o}-switch--loading`,this.pressed&&`${o}-switch--pressed`,this.rubberBand&&`${o}-switch--rubber-band`],tabindex:this.mergedDisabled?void 0:0,style:this.cssVars,onClick:this.handleClick,onFocus:this.handleFocus,onBlur:this.handleBlur,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},c("div",{class:`${o}-switch__rail`,"aria-hidden":"true",style:h},U(x,v=>U(C,T=>v||T?c("div",{"aria-hidden":!0,class:`${o}-switch__children-placeholder`},c("div",{class:`${o}-switch__rail-placeholder`},c("div",{class:`${o}-switch__button-placeholder`}),v),c("div",{class:`${o}-switch__rail-placeholder`},c("div",{class:`${o}-switch__button-placeholder`}),T)):null)),c("div",{class:`${o}-switch__button`},U(A,v=>U($,T=>U(_,z=>c(po,null,{default:()=>this.loading?c(xo,{key:"loading",clsPrefix:o,strokeWidth:20}):this.checked&&(T||v)?c("div",{class:`${o}-switch__button-icon`,key:T?"checked-icon":"icon"},T||v):!this.checked&&(z||v)?c("div",{class:`${o}-switch__button-icon`,key:z?"unchecked-icon":"icon"},z||v):null})))),U(x,v=>v&&c("div",{key:"checked",class:`${o}-switch__checked`},v)),U(C,v=>v&&c("div",{key:"unchecked",class:`${o}-switch__unchecked`},v)))))}});export{Io as _,Ho as a};
